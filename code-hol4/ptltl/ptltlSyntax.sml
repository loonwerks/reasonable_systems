...
fun mk_relational_data (t1,t2,t3) =
    list_mk_comb(const_mk_relational_data,[t1,t2,t3])
...
fun dest_decide_formula t =
 let val [a,b,c,d] = ndest const_decide_formula 4 (ERR "dest_decide_formula" "") t
 in (a,b,c,d)
 end
...
val dest_mk_relational_data =
     dest_triop const_mk_relational_data (ERR "dest_relational_data" "")
